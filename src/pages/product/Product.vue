<template>
        ...
        <el-dialog :title="title" :visible.sync="visible" @close="closeModal">
            <el-form :model="product" :rulers="rules" ref="productForm">
                <el-form-item label="产品" label-width="100px" prop="name">
                ...
                <el-form-item label="介绍" label-width="100px">
                    <el-input type="textarea" v-model="product.description" auto-complete="off">
                    </el-input>
                </el-form-item>
            </el-form>
